...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  const updates = [
    ...
    { title: 'তামরীন AI-তে যুক্ত হলো আল-কুরআন ও হাদিসের সরাসরি রেফারেন্স অনুবাদ সিস্টেম।', date: '৩০ জুলাই ২০২৬' },
  ];
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 relative z-10">
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              সহকারী শিক্ষক (আরবি), প্রভাষক (হাদিস/ফিকহ), সহকারী মৌলভী ও ইবতেদায়ী পদের জন্য তামরীন একাডেমির বিশ্বস্ত আরবি-বাংলা-ইংরেজি সিলেবাস, তামরীন AI, মডেল টেস্ট ও প্র্যাকটিস প্ল্যাটফর্ম।
            </p>
      ...
      <section className="bg-gradient-to-r from-amber-500 via-amber-600 to-emerald-800 text-slate-950 rounded-3xl p-6 sm:p-8 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-center sm:text-left">
          ...
          <p className="text-xs sm:text-sm text-slate-900 font-medium max-w-xl">
            সকল বিষয়ভিত্তিক প্রিমিয়াম কোর্স, আনলিমিটেড তামরীন AI প্রম্পট, লাইভ মক টেস্ট ও অধ্যায়ভিত্তিক বিগত বছরের সমাধানের পূর্ণাঙ্গ এক্সেস পান।
          </p>
        </div>
