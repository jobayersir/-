                  ...
                  {isRtl ? (
                    ...
                    <div dir="rtl" className="space-y-1 text-right font-arabic">
                      <div className="flex items-start gap-2.5">
                        ...
                        <h3 
                          className="text-slate-900 dark:text-slate-100 font-extrabold text-[17px] leading-relaxed flex-1 pt-0.5"
                    ...
                    <div dir="ltr" className="space-y-1 text-left">
                      <div className="flex items-start gap-2.5">
                        ...
                        <h3 
                          className="text-slate-900 dark:text-slate-100 font-extrabold text-[17px] leading-snug flex-1 pt-0.5"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="pt-3 space-y-2">
                        <h4 className="font-bold text-[17px] text-slate-900 dark:text-slate-100 leading-relaxed">
                          {q.question}
                        </h4>
                      </div>
